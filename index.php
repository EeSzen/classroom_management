  ...
  <body>
    <div class="card rounded shadow-sm mx-auto my-4" style="max-width: 500px">
      ...
      <?php if( isset( $_SESSION["user"])):?>
        ...
        <a href="logout.php"><button class="btn btn-sm btn-danger">Log Out</button></a>
        ...
        <a href="login.php"><button class="btn btn-sm btn-primary">Login</button></a>
        <a href="signup.php"><button class="btn btn-sm btn-primary">Sign Up</button></a>
        <?php endif;?>
      </div>
    </div>
